...
/*BG Code For Get The Events type Custom Fields*/
if($post_type == 'events'){
echo'<div class="container"><div class="row events_custmfields">';
echo'<div class="col-sm-4 events_custmfields_clm"><label>Event Location</label><span class="location"><i class="fa fa-map-marker" aria-hidden="true"></i>
'.get_field("location_of_event").'</span></div>';
								     

echo'<div class="col-sm-4 events_custmfields_clm"><label>Event Date</label><span class="date"><i class="fa fa-calendar" aria-hidden="true"></i>
'.get_field("date").'</span></div>';

echo'<div class="col-sm-4 events_custmfields_clm"><label>Event Time</label><span class="time"><i class="fa fa-clock-o" aria-hidden="true"></i>
'.get_field("time").'</span></div>';

echo'</div></div>';
} 
/*BG Code For Get The Events type Custom Fields End*/
